...
using Karma.Business.Modules.ShopModule.Commands.BasketAddCommand;
using Karma.Business.Modules.ShopModule.Commands.BasketChangeQuantityCommand;
using Karma.Business.Modules.ShopModule.Commands.CreateOrderCommand;
using Karma.Business.Modules.ShopModule.Commands.RemoveFromBasketCommand;
using Karma.Business.Modules.ShopModule.Commands.SetRateCommand;
...
using Karma.Business.Modules.ShopModule.Queries.GetPriceQuery;
