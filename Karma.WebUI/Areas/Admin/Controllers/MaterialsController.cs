using Karma.Business.Modules.MaterialsModule.Commands.MaterialAddCommand;
using Karma.Business.Modules.MaterialsModule.Commands.MaterialEditCommand;
using Karma.Business.Modules.MaterialsModule.Commands.MaterialRemoveCommand;
using Karma.Business.Modules.MaterialsModule.Queries.MaterialGetAllQuery;
using Karma.Business.Modules.MaterialsModule.Queries.MaterialGetByIdQuery;
using MediatR;
